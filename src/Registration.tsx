      ...
      <div className="min-h-screen text-white flex items-center justify-center px-4 py-28">
        ...
        >
          ...
          <div className="relative mt-8 space-y-5">
            {/* Inputs same as before, just updated colors */}
            ...
            {/* College */}
            <div className="relative">
              <School className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-white/60 pointer-events-none" />
              <Input
                id="college"
                type="text"
                name="college"
            ...
            {/* Transaction ID */}
            <div className="relative">
              <DollarSign className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-white/60 pointer-events-none" />
              <Input
                id="transactionId"
                type="text"
                name="transactionId"
              ...
              <div className="flex items-center gap-3">
                <div className="relative flex-1">
                  <Input
                    ...
                    name="screenShot"
                    accept="image/*"
                    onChange={(e) => setInput({ ...input, screenShot: e.target.files?.[0] || undefined })}
                  ...
                  />
                  <ImageIcon className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-white/60 pointer-events-none" />
                </div>
              </div>
            ...
            {/* Repeat same structure for Name, Phone, College, Transaction ID... */}
            {/* For screenshot input too, just keep file input styled black/white */}
...
//           <pointLight position={[4, 3, 2]} intensity={1.2} />
//           <Stars radius={80} depth={50} count={2000} factor={4} saturation={0} fade />
//           <GlowSphere />
//           <WireTorus />
//         </Canvas>
...
//         <form
//           onSubmit={handleSubmit}
//           className="w-full max-w-lg rounded-2xl bg-white/10 border border-white/20 shadow-[0_10px_40px_rgba(0,0,0,0.35)] p-6 md:p-8 backdrop-blur-md relative"
//         >
//           {/* subtle glowing ring behind the card */}
//           <div className="pointer-events-none absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-cyan-400/20 to-fuchsia-500/20 blur-2xl" />

//           <h1 className="relative text-center text-4xl md:text-5xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-sky-400 to-fuchsia-400">
//             Registration Form
//           </h1>
//           <p className="relative mt-2 text-center text-white/70 text-sm">
//             Join the event and secure your spot
...
//           <button
//             type="submit"
//             className="relative mt-8 w-full h-12 rounded-xl font-semibold bg-gradient-to-r from-cyan-400 to-fuchsia-500 text-black shadow-lg shadow-cyan-500/20 hover:brightness-110 active:scale-[0.99] transition"
//           >
//             Submit
//           </button>
//         </form>
